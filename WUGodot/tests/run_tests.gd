...
const _TEST_MODULES: Array[String] = [
	...
	"res://tests/test_reward_rarity.gd",
	...
	"res://tests/test_school_icons.gd",
	...
	"res://tests/test_combat_sfx.gd",
	"res://tests/test_combat_guard_root.gd",
