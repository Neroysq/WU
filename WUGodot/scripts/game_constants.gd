...
const COLOR_TEXT_BODY: Color = Color8(198, 183, 190)
const COLOR_TEXT_HINT: Color = Color8(150, 178, 197)
const COLOR_TEXT_CAPTION: Color = Color8(86, 90, 117)
const COLOR_TEXT_DISABLED: Color = Color(198.0 / 255.0, 183.0 / 255.0, 190.0 / 255.0, 0.45)
const COLOR_TEXT_ACCENT: Color = Color8(238, 156, 36)
const COLOR_SCREEN_VIGNETTE: Color = Color(15.0 / 255.0, 15.0 / 255.0, 27.0 / 255.0, 0.24)
